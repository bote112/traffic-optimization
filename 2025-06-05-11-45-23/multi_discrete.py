...
class SumoEnv(gym.Env):
    ...
    def step(self, action):
        ...
        for tls_id in self.tls_ids:
            ...
            if current_phase in self.valid_phases_map[tls_id]:
                ...
                next_green = decoded_action[tls_id]["phase"]
                new_duration = decoded_action[tls_id]["duration"]
                
                traci.trafficlight.setPhase(tls_id, next_green)
                self.active_green_duration[tls_id] = new_duration
                self.last_phase_change_step[tls_id] = self.step_count
    ...
    def _get_reward(self):
        ...
        gridlock_penalty = -newly_teleported * 20.0
        ...
        for tls_id in self.tls_ids:
            ...
            stale_phase_penalty -= time_in_current_phase * 0.005
